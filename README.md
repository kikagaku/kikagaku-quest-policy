...
2.	ユーザーが受験料金の支払を遅滞した場合、当社の裁量で、ユーザー若しくはエンドユーザーはテストを受験することができない又は年１４．６％の割合による遅延損害金を当社に支払う、いずれかの措置がとられることをあらかじめ承諾するものとします。
...
## 第８条 （法人ユーザーによる利用の特則）
1.	
2.	法人ユーザーは、エンドユーザーに本サービスを利用させる場合、自己の責任において、エンドユーザーに本ポリシーを遵守させなければならず、エンドユーザーの行為について責任を負うものとします。エンドユーザーの本ポリシー違反は法人ユーザーの違反とみなし、当社は法人ユーザーに対して本ポリシーに沿った措置をとることができるものとし、法人ユーザーはあらかじめこれを承諾し、当社に協力するものとします。
3.	法人ユーザーは、本サービスにおいてテストを受験させるエンドユーザーの情報（人数、所属、氏名等を含みますが、これらに限られません。）について、当社が求める場合には、必要な資料等を提出して、当社に通知しなければなりません。
4.	エンドユーザーに本サービスに関するパスワード及び個別のＩＤが付与される場合、エンドユーザーにこれらを適切に管理及び保管させるものとし、第三者に利用させ又は貸与、譲渡、名義変更、売買等をさせてはなりません。当社は、当該ＩＤとパスワードの一致を確認した場合、当該ＩＤ及びパスワードを保有するエンドユーザーが本サービスを利用したものとみなし、ユーザーはあらかじめこれに了承し同意するものとし、またエンドユーザーにこれを了承させるものとします。
